...
/**
 * Initialise and play the video file
 *
 * @param {String} src  the video file URL
 */
...
/**
 * Check the status of the video processing
 *
...
/**
 * Submit the form with data to transform the video to MOV
 */
